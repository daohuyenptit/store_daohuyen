package com.example.daohuyen.swagger;
...
public class SwaggerConfig {
    ...
    public Docket postsApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)/*.configure(new DocumentationContextBuilder().)*/
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.daohuyen"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Store service API")
                ...
                .contact("daohuyen-mobile@gmail.com").license("Huyen License")
                .licenseUrl("daohuyen-mobile@gmail.com").version("1.0")
                .build();
    }
}
